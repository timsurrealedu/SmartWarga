...
export default function App() {
  ...
  return (
    <div className="flex min-h-screen bg-canvas font-sans relative">
      ...
      <div className="flex-1 md:ml-64 flex flex-col h-screen w-full min-w-0">
        <Header currentRole={currentRole} currentTab={currentTab} toggleSidebar={() => setIsSidebarOpen(true)} onProfileClick={() => setCurrentTab(currentRole === "admin" ? "admin_profile" : "profile")} />
        <main className="flex-1 overflow-y-auto overflow-x-hidden p-4 pb-28 md:p-8 md:pb-8 bg-canvas selection:bg-primary/30">
